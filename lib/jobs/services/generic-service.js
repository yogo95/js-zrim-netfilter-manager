...
GenericServiceJob.prototype._generateRules = function (context) {
  return new Promise(resolve => {
    ...
    const chainName = this._getServiceChainName();
    ...
    installCommands.push(this._asIptables4Command(`-I IN_services_access_0 0 -j IN_${chainName}`));
    installCommands.push(this._asIptables4Command(`-I OUT_services_access_0 0 -j OUT_${chainName}`));
